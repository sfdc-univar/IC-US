...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        ...
        <recipients>
            <recipient>NC24NCESalesManagerKCOmaha</recipient>
            <type>role</type>
        </recipients>
        <recipients>
            <recipient>NC24NCFSalesManagerStLouisSFBR</recipient>
            <type>role</type>
        </recipients>
        <recipients>
        ...
        <recipients>
            <recipient>NC3GeneralManagers</recipient>
            <type>role</type>
        </recipients>
        <recipients>
    ...
    <alerts>
        ...
        <recipients>
            <recipient>NE44SENSalesManager_SP</recipient>
            <type>role</type>
        </recipients>
        <recipients>
        ...
        <recipients>
            <recipient>NE54SEASalesManagerFlorida</recipient>
            <type>role</type>
        </recipients>
        <recipients>
    ...
    <rules>
        <fullName>BDA%3A Eastern RSD and Sales Ops for NEW - no limit -2</fullName>
        <actions>
...
ISPICKVAL( StageName , &quot;Closed Won&quot;))</formula>
    ...
    <rules>
        <fullName>BDA%3A Western RSD and Sales Ops for NEW - no limit -2</fullName>
        <actions>
    ...
    <rules>
        ...
        <description>Send Email to Regional Sales Directors and Steve Moore &amp; Ben Ortiz when a new opportunity, over $250k, is created.</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <description>Send Email to Regional Sales Director, Steve Moore &amp; Ben Ortiz when a WON opportunity, over $250k, is saved.</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>BDA%3AEastern RSD and Sales Ops for LOST - no limit -2</fullName>
        <actions>
    ...
    <rules>
        <fullName>BDA%3AEastern RSD and Sales Ops for WON - no limit -2</fullName>
        <actions>
    ...
    <rules>
        <fullName>BDA%3AWestern RSD and Sales Ops for LOST - no limit -2</fullName>
        <actions>
    ...
    <rules>
        <fullName>BDA%3AWestern RSD and Sales Ops for WON - no limit -2</fullName>
        <actions>
    ...
    <rules>
        ...
        <formula>LOWER(USPOT_Insight_Type__c) = &apos;order at risk&apos; ||
LOWER(USPOT_Insight_Type__c) = &apos;customer at risk&apos; ||
LOWER(USPOT_Insight_Type__c) = &apos;baskets at risk&apos;</formula>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
